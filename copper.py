...
if selected == 'Selling_Price_Prediction':
    ...
    df=pd.read_csv('C:/Users/Welcome/OneDrive/Desktop/CopperModel/Clean_Selling_price.csv')
    del df['Unnamed: 0']
    print(df)
...
if selected == 'Status_Prediction':
    ...
    df1=pd.read_csv('C:/Users/Welcome/OneDrive/Desktop/CopperModel/Cleaned_Status.csv')
    del df1['Unnamed: 0']
    print(df1)
